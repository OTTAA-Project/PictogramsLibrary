...
public class GlideAttatcher implements GlideModelTypes {
    ...
    * */
    ...
    public Object loadDrawable(@Nullable Bitmap bitmap, ImageView imageView) {
        if(isValidContext(mContext))
            glideScaleItem(cornerRadious(useDecodeFormat(useDiskCacheStrategic(getGlide().getRequestManagerRetriever().get(mContext).load(bitmap))))).fallback(R.drawable.ic_baseline_cloud_download_24).into(imageView).waitForLayout();
        return this;
    }
    ...
    public Object loadDrawable(@Nullable Drawable drawable, ImageView imageView) {
           if(isValidContext(mContext))
            glideScaleItem(cornerRadious(useDecodeFormat(useDiskCacheStrategic(getGlide().getRequestManagerRetriever().get(mContext).load(drawable))))).into(imageView).waitForLayout();
        return this;
    }
    ...
    public Object loadDrawable(@Nullable String string, ImageView imageView) {
        if(isValidContext(mContext))
            glideScaleItem(cornerRadious(useDecodeFormat(useDiskCacheStrategic(getGlide().getRequestManagerRetriever().get(mContext).load(string))))).into(imageView).waitForLayout();
        return this;
    }
    ...
    public Object loadDrawable(@Nullable Uri uri, ImageView imageView) {
        if(isValidContext(mContext))
            glideScaleItem(cornerRadious(useDecodeFormat(useDiskCacheStrategic(getGlide().getRequestManagerRetriever().get(mContext).load(uri).error(R.drawable.ic_baseline_cloud_download_24))))).into(imageView).waitForLayout();
        return this;
    }
    ...
    public Object loadDrawable(@Nullable File file, ImageView imageView) {
        if(isValidContext(mContext))
            glideScaleItem(cornerRadious(useDecodeFormat(useDiskCacheStrategic(getGlide().getRequestManagerRetriever().get(mContext).load(file))))).into(imageView).waitForLayout();
        return this;
    }
    ...
    public Object loadDrawable(@Nullable Integer resourceId, ImageView imageView) {
        if(isValidContext(mContext))
            glideScaleItem(cornerRadious(useDecodeFormat(useDiskCacheStrategic(getGlide().getRequestManagerRetriever().get(mContext).load(resourceId))))).into(imageView).waitForLayout();
        return this;
    }
    ...
    public Object loadDrawable(@Nullable URL url, ImageView imageView) {
        if(isValidContext(mContext))
            glideScaleItem(cornerRadious(useDecodeFormat(useDiskCacheStrategic(getGlide().getRequestManagerRetriever().get(mContext).load(url).signature(new ObjectKey(url)).error(R.drawable.ic_baseline_cloud_download_24))))).into(imageView).waitForLayout();
        return this;
    }
    ...
    public Object loadDrawable(@Nullable byte[] model, ImageView imageView){
        if(isValidContext(mContext)) {
            glideScaleItem(cornerRadious(useDecodeFormat(useDiskCacheStrategic(getGlide().getRequestManagerRetriever().get(mContext).load(model))))).into(imageView).waitForLayout();
        }
        return this;
    }
    ...
    public RequestBuilder<Drawable> overrideMethod(RequestBuilder<Drawable> drawableRequestBuilder){
        return drawableRequestBuilder.override(width);
    }
